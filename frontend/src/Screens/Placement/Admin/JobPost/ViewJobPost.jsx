...
const ViewJobPost = () => {
  ...
  return (
    <>
      <MetaData title='Job Post details' />
      <section id='Jobpost-details' className='w-full h-full  mt-20'>
          ...
          {loading === false ? (
            job && (
              <div className='max-w-[1200px] w-[100%] mx-auto my-10'>
                ...
                <div className='w-[90%] mx-auto bg-blue-200 border-2 border-solid rounded-[10px] mt-20'>
